        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative overflow-hidden rounded-2xl">
              ...
              {/* Floating elements */}
              <motion.div
                className="absolute -top-4 -right-4 w-20 h-20 bg-brand-green/20 rounded-full blur-xl"
                animate={{
                  scale: [1, 1.1, 1],
                  opacity: [0.3, 0.6, 0.3],
                }}
              ...
              />
              <motion.div
                className="absolute -bottom-4 -left-4 w-16 h-16 bg-brand-blue/20 rounded-full blur-xl"
                animate={{
                  scale: [1.1, 1, 1.1],
                  opacity: [0.6, 0.3, 0.6],
                }}
