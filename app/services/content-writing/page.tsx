...
export const metadata: Metadata = {
  title: 'Content Writing · Services · Heed Digital',
  description: 'Words that move people, and algorithms. Compelling copy that connects with your audience and drives action across all marketing channels.',
  openGraph: {
    title: 'Content Writing · Services · Heed Digital',
    description: 'Words that move people, and algorithms. Compelling copy that connects with your audience and drives action across all marketing channels.',
  },
...
export default function ContentWritingServicePage() {
  const service = getService('content-writing')
