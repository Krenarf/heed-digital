...
export const metadata: Metadata = {
  title: 'Marketing Strategy · Services · Heed Digital',
  description: 'A plan that compounds, not campaigns that fade. Data-driven marketing strategies that grow your brand and deliver measurable business results.',
  openGraph: {
    title: 'Marketing Strategy · Services · Heed Digital',
    description: 'A plan that compounds, not campaigns that fade. Data-driven marketing strategies that grow your brand and deliver measurable business results.',
  },
