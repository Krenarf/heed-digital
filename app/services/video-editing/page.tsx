...
const deliverables = [
  'MP4 + SRT',
  'Project handoff (add-on)'
]

const relatedWork = [
  {
    title: 'Viral Marketing Video Series',
    summary: 'A repeatable edit formula that scaled views fast.',
  ...
  },
  {
    ...
    summary: 'Hook-driven product showcases that convert.',
      ...
      <nav className="section-padding bg-gray-800">
        <Container>
          <div className="flex items-center space-x-2 text-sm text-gray-400">
            ...
            <span>/</span>
            <span className="text-fg">Video Editing</span>
          </div>
        </Container>
      </nav>
          ...
          >
            ...
            <div className="text-center mb-12">
              <h1 className="text-4xl lg:text-5xl font-bold mb-6 text-fg">
                Video <span className="gradient-text">Editing</span>
              </h1>
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">
                Hook-first edits that keep people watching.
              </p>
            </div>
        ...
        <Container>
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              See examples of our video editing work in action
            </p>
          </motion.div>
