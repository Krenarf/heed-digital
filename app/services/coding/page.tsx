...
export const metadata: Metadata = {
  title: 'Code & Implementation · Services · Heed Digital',
  description: 'From idea to shipped, clean, fast, maintainable. Custom websites and web applications built with modern technologies and best practices.',
  openGraph: {
    title: 'Code & Implementation · Services · Heed Digital',
    description: 'From idea to shipped, clean, fast, maintainable. Custom websites and web applications built with modern technologies and best practices.',
  },
...
export default function CodingServicePage() {
  const service = getService('coding')
